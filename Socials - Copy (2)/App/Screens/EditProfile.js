            ...
            <ScrollView>
                ...
                <View style={styles.container}>
                    ...
                    <View style={{ padding: 20 }}>
                        ...
                        <TouchableOpacity style={{ alignItems: "center", justifyContent: "center", backgroundColor: "dodgerblue", marginTop: 40, height: 40 }} onPress={() => { this.isCheck(); }}>

                            <Text style={{ fontSize: 20, alignSelf: "center", color: "white" }}>UPDATE</Text>
